...
mimic_train=readmatrix("MIMIC/fold_4_train.csv");
mimic_test=readmatrix("MIMIC/fold_4_test.csv");

repo_train=readmatrix("repo/train_fold_4.csv");
repo_test=readmatrix("repo/test_fold_4.csv");

symulator_train=readmatrix("symulator/train/symulator_af.csv");

psynet_train=readmatrix("psynet/fold_3_train_psynet.csv");
psynet_test=readmatrix("psynet/fold_3_test_psynet.csv");
...
writematrix(train_dataset, "fold_4_train_no_features.csv");
writematrix(test_dataset, "fold_4_test_no_features.csv");

csv=extract_and_save(test_dataset,"fold_4_test.csv");
csv=extract_and_save(train_dataset,"fold_4_train.csv");
