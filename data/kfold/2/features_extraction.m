...
mimic_train=readmatrix("MIMIC/fold_2_train.csv");
mimic_test=readmatrix("MIMIC/fold_2_test.csv");

repo_train=readmatrix("repo/train_fold_2.csv");
repo_test=readmatrix("repo/test_fold_2.csv");

symulator_train=readmatrix("symulator/train/symulator_af.csv");

psynet_train=readmatrix("psynet/fold_1_train_psynet.csv");
psynet_test=readmatrix("psynet/fold_1_test_psynet.csv");
...
writematrix(train_dataset, "fold_2_train_no_features.csv");
writematrix(test_dataset, "fold_2_test_no_features.csv");

csv=extract_and_save(test_dataset,"fold_2_test.csv");
csv=extract_and_save(train_dataset,"fold_2_train.csv");
